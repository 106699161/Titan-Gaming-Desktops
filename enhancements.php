...
<!-- PART 2 REFERENCES -->
        ...
        <li>
            PHP Documentation, <em>"PHP Manual"</em>. Available:
        ...
        <li>
            PHP Documentation, <em>"session_start()"</em>. Available:
            <a href="https://www.php.net/manual/en/function.session-start.php" target="_blank">
                https://www.php.net/manual/en/function.session-start.php
            </a>
        </li>

        <li>
            PHP Documentation, <em>"MySQLi Quick Start Guide"</em>. Available:
            <a href="https://www.php.net/manual/en/mysqli.quickstart.php" target="_blank">
                https://www.php.net/manual/en/mysqli.quickstart.php
            </a>
        </li>

        <li>
            PHP Documentation, <em>"mysqli::prepare - Prepared Statements"</em>. Available:
            <a href="https://www.php.net/manual/en/mysqli.prepare.php" target="_blank">
                https://www.php.net/manual/en/mysqli.prepare.php
            </a>
        </li>

        <li>
            PHP Documentation, <em>"Password Hashing Functions"</em>. Available:
            <a href="https://www.php.net/manual/en/ref.password.php" target="_blank">
                https://www.php.net/manual/en/ref.password.php
            </a>
        </li>

        <li>
            PHP Documentation, <em>"filter_input"</em>. Available:
            <a href="https://www.php.net/manual/en/function.filter-input.php" target="_blank">
                https://www.php.net/manual/en/function.filter-input.php
            </a>
        </li>

        <li>
            MySQL, <em>"MySQL 8.0 Reference Manual"</em>. Available:
        ...
        <li>
            MySQL, <em>"Creating and Using a Database"</em>. Available:
            <a href="https://dev.mysql.com/doc/refman/8.0/en/database-use.html" target="_blank">
                https://dev.mysql.com/doc/refman/8.0/en/database-use.html
            </a>
        </li>

        <li>
            MySQL, <em>"Creating Tables"</em>. Available:
            <a href="https://dev.mysql.com/doc/refman/8.0/en/creating-tables.html" target="_blank">
                https://dev.mysql.com/doc/refman/8.0/en/creating-tables.html
            </a>
        </li>

        <li>
            MDN Web Docs, <em>"Responsive Web Design"</em>. Available:
        ...
        <li>
            MDN Web Docs, <em>"CSS Media Queries"</em>. Available:
            <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Media_queries" target="_blank">
                https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Media_queries
            </a>
        </li>

        <li>
            MDN Web Docs, <em>"Using Media Queries"</em>. Available:
            <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Media_queries/Using" target="_blank">
